...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    // so the cron-driven nurture flow (cheatsheet email1 and email2) handles
    // the +24h and +72h follow-ups. Day 1 (cheat sheet delivery) is the only
    // email this function still sends for these forms.
